...
#define TestLoadOneModel memsaver_original_model_load_one
#define main memsaver_original_model_load_main
#include "../tests/model_load_test.cpp"
#undef main
#undef TestLoadOneModel
...
void TestLoadOneModelWithCustomPool(MemSaver& memsaver, const ModelSpec& spec) {
...
int main() {
  ...
  for (const auto& spec : GetModelSpecs()) {
    TestLoadOneModelWithCustomPool(memsaver, spec);
  }
